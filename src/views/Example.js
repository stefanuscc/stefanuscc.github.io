  ...
  return (
    <div className="relative bg-white">
      ...
      <main className="relative bg-white">
          ...
          <div className="max-w-7xl mx-auto bg-gray-800 lg:bg-transparent lg:px-8">
              ...
              <div className="relative bg-gray-800 lg:col-start-3 lg:row-start-1 lg:col-span-10 lg:rounded-3xl lg:grid lg:grid-cols-10 lg:items-center">
                ...
                <div className="relative max-w-md mx-auto py-12 px-4 space-y-6 sm:max-w-3xl sm:py-16 sm:px-6 lg:max-w-none lg:p-0 lg:col-start-4 lg:col-span-6">
                  ...
                  <p className="text-lg text-white">
                    A dedicated <strong>Tech Enthusiast</strong>, <strong>Lead Developer</strong> and <strong>Multistack Software Engineer</strong> with more than <strong>7+ years of experiences</strong> at Startup, IT Consultant, and Self Employed Freelance.
                    Always <strong>eager to learn</strong>, <strong>easily adapt</strong>, and have <strong>great work ethic</strong> might help me alot to collaborate with you.
                  </p>
                  <div className="flex space-x-6 justify-start items-center pt-3">
                      <div className="">
                        <span className="text-white font-medium">Expertise:</span>
                      </div>
                      <svg className="h-12 fill-gray-400" viewBox="0 0 24 24">
                        <title>PHP</title>
                      ...
                      <svg className="h-8  fill-gray-400" viewBox="0 0 24 24">
                        <title>Laravel</title>
